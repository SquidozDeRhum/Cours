...
*@struct element
*
*@brief structure d'un element de la liste chainee

*/
typedef struct Elem {	
    char lettre;		/*!< caractère mémorisé */
    struct Elem * svt;	/*!< pointeur du caractère suivant de la liste chaînée */
}element;	
...
/**
*
* @fn ana(chaine ch1, chaine ch2)
*
* @brief fonction qui indique si deux chaînes sont des anagrammes
*
* @param ch1 : la première chaîne à tester
*
* @param ch2 : la seconde chaîne à tester
*
* @return true si les chaînes sont des anagrammes, false sinon
*
* Enlève un élément de ch2 tant qu'il n'a pas été prouvé que 
* ch1 ch2 ne sont pas des anagrammes
*
*/
bool ana(chaine ch1, chaine ch2){
